export const commonTranslations = {
  workspace: {
    ...
    create: {
      todo: 'Todo erstellen',
      amendment: 'Antrag erstellen',
      event: 'Veranstaltung erstellen',
      agendaItem: 'Tagesordnungspunkt erstellen',
    },
    searchCreate: 'Was möchtest du erstellen?',
    noCreateResults: 'Keine passenden Erstellungsabläufe. Versuche einen anderen Suchbegriff.',
    optionalDetails: 'Weitere Angaben',
    showMap: 'Karte anzeigen',
    hideMap: 'Karte ausblenden',
    noMappedActivity: 'Es sind noch keine Aktivitäten mit Ortsangabe verfügbar.',
    preview: 'Vorschau',
    openPage: 'Vollständige Seite öffnen',
    closePreview: 'Vorschau schließen',
    previewHint:
      'Pfeiltasten zum Wechseln · Leertaste für Vorschau · Enter zum Öffnen · Escape zum Schließen',
    compactView: 'Kompakte Ansicht',
    favorite: 'Zu Favoriten hinzufügen',
    unfavorite: 'Aus Favoriten entfernen',
    favorites: 'Favoriten',
    currentActions: 'Aktionen für diese Seite',
    saveView: 'Diese Ansicht merken',
    saveFailed: 'Deine Änderung konnte nicht gespeichert werden. Bitte erneut versuchen.',
    saving: 'Wird gespeichert…',
    loading: 'Details werden geladen…',
    unavailable: 'Diese Details sind nicht verfügbar oder du hast keinen Zugriff.',
    context: 'Kontext',
    details: 'Details',
