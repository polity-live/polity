export const amendmentsTranslations = {
  ...
  collaborators: {
    ...
    pendingInvitationsTitle: 'Ausstehende Einladungen ({{count}})',
    pendingInvitationsTitle_one: 'Ausstehende Einladung ({{count}})',
    pendingInvitationsTitle_other: 'Ausstehende Einladungen ({{count}})',
    pendingRequestsTitle: 'Ausstehende Mitarbeitsanfragen ({{count}})',
    pendingRequestsTitle_one: 'Ausstehende Mitarbeitsanfrage ({{count}})',
    pendingRequestsTitle_other: 'Ausstehende Mitarbeitsanfragen ({{count}})',
  ...
  process: {
    ...
    groupsCount_one: '{{count}} Gruppe',
    groupsCount_other: '{{count}} Gruppen',
    ...
    agendaItemsCreated_one: '{{count}} Tagesordnungspunkt erstellt',
    agendaItemsCreated_other: '{{count}} Tagesordnungspunkte erstellt',
    votesCreated: '{{count}} Abstimmungen erstellt',
    votesCreated_one: '{{count}} Abstimmung erstellt',
    votesCreated_other: '{{count}} Abstimmungen erstellt',
    ...
    pathDescription_one:
      'Antrag wird durch {{groupName}} mit {{count}} Veranstaltung im Pfad verarbeitet',
    pathDescription_other:
      'Antrag wird durch {{groupName}} mit {{count}} Veranstaltungen im Pfad verarbeitet',
    ...
    branchCount: '{{count}} Textvarianten',
    branchCount_one: '{{count}} Textvariante',
    branchCount_other: '{{count}} Textvarianten',
    ...
    openChangeRequests_one: '{{count}} offener Änderungsantrag',
    openChangeRequests_other: '{{count}} offene Änderungsanträge',
    openTasks: '{{count}} offene Aufgaben',
    openTasks_one: '{{count}} offene Aufgabe',
    openTasks_other: '{{count}} offene Aufgaben',
  ...
  pathVisualization: {
    ...
    shortestPath_one: 'Kürzester Pfad zur Zielgruppe ({{count}} Schritt)',
  ...
  cityDesign: {
    ...
    categoryDelete: {
      ...
      description_one: 'Dadurch entsteht {{count}} einzelner Änderungsantrag für das Element.',
      description_other:
        'Dadurch entstehen {{count}} einzelne Änderungsanträge, einer pro Element.',
      cancel: 'Abbrechen',
      confirm: '{{count}} Änderungsanträge erstellen',
      confirm_one: '{{count}} Änderungsantrag erstellen',
      confirm_other: '{{count}} Änderungsanträge erstellen',
    },
    status: {
      readOnly: 'Nur Lesen',
      saved: 'Gespeichert',
    ...
    canvas: {
      ...
      pointsSet_one: '{{count}} Punkt gesetzt',
      pointsSet_other: '{{count}} Punkte gesetzt',
    },
    sample: {
