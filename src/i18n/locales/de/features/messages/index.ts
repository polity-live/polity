export const messagesTranslations = {
  ...
  toasts: {
    ...
    conversationDeleting: 'Unterhaltung wird im Hintergrund gelöscht …',
    conversationDeleted: 'Unterhaltung gelöscht',
    conversationDeleteFailed: 'Unterhaltung konnte nicht gelöscht werden',
    conversationRejecting: 'Unterhaltung wird im Hintergrund abgelehnt …',
    conversationRejected: 'Unterhaltung abgelehnt',
    conversationRejectFailed: 'Unterhaltung konnte nicht abgelehnt werden',
  ...
  ai: {
    ...
    compressingHistory: 'Assistent Aria & Kai komprimiert gerade den Chatverlauf...',
    defaultConversationName: 'Assistent Aria & Kai',
