export const eventsTranslations = {
  ...
  editPage: {
    ...
    untitled: 'Unbenannte Veranstaltung',
    ...
    saving: 'Speichern...',
    finalVoteDurationLabel: 'Standarddauer der Endabstimmung',
    finalVoteDurationNoAutoClose: 'Kein automatisches Schließen',
    finalVoteDurationHint:
      'Wird als Standard-Schließtimer für Endabstimmungen aus dieser Tagesordnung verwendet.',
    finalVoteDurationInvalid: 'Gib eine gültige Dauer für die Endabstimmung ein.',
    basicInfo: {
  ...
  agenda: {
    ...
    speakerCount_other: '{{count}} Redner',
    ...
    itemsCount_one: 'Tagesordnungspunkt ({{count}})',
    itemsCount_other: 'Tagesordnungspunkte ({{count}})',
    ...
    joiningSpeakerList: 'Rednerliste wird betreten',
    leaveSpeakerList: 'Rednerliste verlassen',
    leavingSpeakerList: 'Rednerliste wird verlassen',
    ...
    upNext: 'Als Nächstes',
    hideSpeakerList: 'Redeliste ausblenden',
    showSpeakerList: 'Redeliste anzeigen',
    ...
    youSpeakerPosition: 'Du: #{{position}}',
    genderQuota: {
    ...
    selected: 'Ausgewählt',
    winner: 'Gewinner',
    openNamedResults: 'Einzelansicht öffnen',
    ...
    defaultChoiceLabels: {
      ...
      abstain: 'Enthaltung',
      choice: 'Option',
      choiceWithNumber: 'Option {{count}}',
    },
    namedResults: {
      label: 'Namentlich',
      title: 'Namentliche Ergebnisse',
      totalResult: 'Gesamtergebnis',
      offlineShare: 'davon {{count}} offline',
    ...
    candidate: 'Kandidat',
    completeCurrentItem: 'Aktuellen Punkt abschließen',
    defaultCandidateWithNumber: 'Kandidat {{count}}',
    manageOfflineTally: 'Offline-Auszählung verwalten',
    nextAgendaItem: 'Nächster Tagesordnungspunkt',
    offlineTallyDescription: 'Offline-Stimmen für {{item}} verwalten.',
    roleLowercase: 'Rolle',
    role: 'Rolle',
    roleDetails: 'Rollendetails',
    thisElection: 'diese Wahl',
    thisItem: 'diesen Punkt',
    thisVote: 'diese Abstimmung',
    ...
    actions: {
      ...
      castIndicativeVote: 'Stimmungsbild abgeben',
      closeFinalVote: 'Endabstimmung schließen',
      joinSpeakerList: 'Redeliste beitreten',
      leaveSpeakerList: 'Redeliste verlassen',
      offlineCRVoteUnavailable:
        'Offline-Abstimmung ist für diesen Änderungsantrag nicht verfügbar.',
      secretIndicativeVoteAlreadyCast: 'Du hast bereits ein geheimes Stimmungsbild abgegeben.',
      startFinalVote: 'Endabstimmung starten',
      startVote: 'Abstimmung starten',
      voteRequiresActiveVotingRight: 'Aktives Stimmrecht ist für die Abstimmung nötig.',
      voteUnavailable: 'Abstimmung ist nicht verfügbar.',
      withdrawCandidacy: 'Kandidatur zurückziehen',
    },
  },
  participants: {
    ...
    activeParticipants_one: 'Aktiver Teilnehmer ({{count}})',
    activeParticipants_other: 'Aktive Teilnehmer ({{count}})',
    ...
    inviteSuccess: '{{count}} Teilnehmer erfolgreich eingeladen',
    inviteSuccess_one: '{{count}} Teilnehmer erfolgreich eingeladen',
    inviteSuccess_other: '{{count}} Teilnehmer erfolgreich eingeladen',
    table: {
      user: 'Benutzer',
      email: 'E-Mail',
      role: 'Rolle',
  ...
  roles: {
    ...
    guestVotingRightsDisabled:
      'Gast-Stimmrechte sind für dieses Event deaktiviert. Weise Teilnehmer stattdessen einer Rolle zu.',
    scheduled: 'Geplant',
  },
  network: {
    title: 'Netzwerk',
  ...
  wiki: {
    ...
    participantsRegistered_one: '{{count}} Teilnehmer für diese Veranstaltung registriert',
    participantsRegistered_other: '{{count}} Teilnehmer für diese Veranstaltung registriert',
    noParticipantsMatch: 'Keine Teilnehmer passen zu deiner Suche.',
    ...
    candidatesCount_one: '{{count}} Kandidat',
    candidatesCount_other: '{{count}} Kandidaten',
  ...
  candidacy: {
    ...
    role: 'Rolle',
    currentCandidates: 'Aktuelle Kandidaten',
    currentCandidates_one: 'Aktueller Kandidat',
    currentCandidates_other: 'Aktuelle Kandidaten',
    votingMethod: 'Wahlverfahren',
  ...
  cancel: {
    ...
    reassign: {
      ...
      itemCount_one: 'Punkt wird übertragen',
      itemCount_other: 'Punkte werden übertragen',
    },
  },
} as const;
