export const amendmentsTranslations = {
  ...
  workflow: {
    ...
    viewing: 'Viewing',
    internalSuggesting: 'Internal Suggesting',
    internalVoting: 'Internal Voting',
    eventSuggesting: 'Event Suggesting',
    eventVoting: 'Event Voting',
    passed: 'Passed',
    rejected: 'Rejected',
  },
  workflowPhases: {
  ...
  editContent: {
    ...
    statusMetadataDescription: 'Track the amendment progress',
    statusLabel: 'Status',
    ...
    dateLabel: 'Date',
    datePlaceholder: 'e.g., March 15, 2024',
    supportersLabel: 'Supporters',
    supportersPlaceholder: 'Number of supporters',
