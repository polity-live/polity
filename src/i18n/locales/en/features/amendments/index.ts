export const amendmentsTranslations = {
  title: 'Amendments',
  cityDesignPreviewUnavailable: 'City Design preview unavailable.',
  ...
  voteControls: {
    ...
    collaboratorsWithVoteRightVoted: '{{voted}}/{{total}} collaborators with vote right voted',
  ...
  eventSuggestions: {
    ...
    cancelConfirmed: 'Suggestion cancelled',
    cancelFailed: 'The suggestion could not be cancelled',
    cancelled: 'Cancelled',
    confirm: 'Confirm suggestion',
    confirmFailed: 'The suggestion could not be confirmed',
    confirmMissingCrId: 'The suggestion is not linked to a change request.',
    confirmMissingDiscussion: 'The suggestion has no linked discussion.',
    confirmed: 'Confirmed',
    pendingOtherDescription:
      'This suggestion is waiting for confirmation by the submitting person.',
    pendingOwnDescription: 'Confirm or cancel your submitted suggestion.',
    pendingTitle: 'Suggestion awaiting confirmation',
  ...
  changeRequests: {
    ...
    actions: {
      abstain: 'Abstain',
      accept: 'Accept',
      finalizeInternalVote: 'Finalize vote',
      finalizeInternalVoteQuestion: 'Finalize this internal vote?',
      reject: 'Reject',
    },
    finalizeResult: 'The current vote result will be applied.',
    voteRequiredDescription: 'Cast your vote before this change request can be finalized.',
    votes: {
      youVoted: 'You voted to',
    },
    voteControls: {
      accept: 'Accept',
      reject: 'Reject',
  ...
  collaborators: {
    title: 'Collaborators',
    badge: 'Collaborator',
    activeTitle: 'Active Collaborators ({{count}})',
    activeTitle_one: 'Active Collaborator ({{count}})',
    activeTitle_other: 'Active Collaborators ({{count}})',
    pendingInvitationsTitle: 'Pending Invitations ({{count}})',
    pendingInvitationsTitle_one: 'Pending Invitation ({{count}})',
    pendingInvitationsTitle_other: 'Pending Invitations ({{count}})',
    pendingRequestsTitle: 'Pending Collaboration Requests ({{count}})',
    pendingRequestsTitle_one: 'Pending Collaboration Request ({{count}})',
    pendingRequestsTitle_other: 'Pending Collaboration Requests ({{count}})',
  ...
  process: {
    ...
    agendaItemsCreated_one: '{{count}} agenda item created',
    agendaItemsCreated_other: '{{count}} agenda items created',
    votesCreated: '{{count}} votes created',
    votesCreated_one: '{{count}} vote created',
    votesCreated_other: '{{count}} votes created',
    ...
    networkTargetDescription: 'Select a reachable target group starting from {{group}}.',
    startGroupFallback: 'the starting group',
    groupFallback: 'Group',
    noDate: 'No date',
    ...
    pathDescription_one:
      'Amendment will be processed through {{groupName}} with {{count}} event in the path',
    pathDescription_other:
      'Amendment will be processed through {{groupName}} with {{count}} events in the path',
    ...
    branchCount: '{{count}} text variants',
    branchCount_one: '{{count}} text variant',
    branchCount_other: '{{count}} text variants',
    ...
    openChangeRequests: '{{count}} open change requests',
    openChangeRequests_one: '{{count}} open change request',
    openChangeRequests_other: '{{count}} open change requests',
    openTasks: '{{count}} open tasks',
    openTasks_one: '{{count}} open task',
    ...
    tasksNeedAttention_one: '{{count}} task needs attention',
    tasksNeedAttention_other: '{{count}} tasks need attention',
    notScheduled: 'Not scheduled',
    eventBeforePreviousStep: 'An event is scheduled before the previous process step.',
    eventAfterNextStep: 'An event is scheduled after the next process step.',
    schedulingAfterPrevious: 'This event must begin after the previous process step.',
    schedulingOutsideTaskWindow: 'This event is outside the allowed time window for the task.',
    pathModes: {
  ...
  pathVisualization: {
    ...
    shortestPath_one: 'Shortest path to target group ({{count}} step)',
    shortestPath_other: 'Shortest path to target group ({{count}} steps)',
    start: 'Start',
    path: 'Path',
  ...
  cityDesign: {
    ...
    defaultTitle: 'City Design',
    savedTitleWithAmendment: '{{title}} - City Design',
    save: 'Save',
    saving: 'Saving...',
    ...
    categoryDelete: {
      ...
      description_one: 'This creates {{count}} separate change request for the element.',
      description_other: 'This creates {{count}} separate change requests, one for each element.',
      cancel: 'Cancel',
      confirm: 'Create {{count}} change requests',
      confirm_one: 'Create {{count}} change request',
      confirm_other: 'Create {{count}} change requests',
    },
    status: {
      readOnly: 'Read only',
      saved: 'Saved',
    ...
    metrics: {
      ...
      changeRequests_one: '{{count}} CR',
      changeRequests_other: '{{count}} CRs',
      cost: '{{cost}}',
    ...
    topbar: {
      ...
      changeRequestsCount_one: '{{count}} CR',
      changeRequestsCount_other: '{{count}} CRs',
      colorCrChanges: 'Color changes',
      insert: 'Insert',
      layers: 'Layers',
      noChangeRequests: 'No City Design change requests.',
    ...
    help: {
      ...
      trigger: 'Show City Design navigation help',
    ...
    inspector: {
      ...
      height: 'Height',
      incline: 'Incline',
      suggestedCostShort: 'Suggested price',
    ...
    changeRequests: {
      ...
      objectFallback: 'City Design object',
      unitPriceChanged: 'City Design unit price changed: {{object}}',
      objectChanged: 'City Design object {{changeType}}: {{object}}',
      reply: 'Reply...',
    ...
    canvas: {
      ...
      pointsSet_one: '{{count}} point set',
      pointsSet_other: '{{count}} points set',
    },
    sample: {
  ...
  branches: {
    branch: 'Branch',
    numbered: 'Branch {{number}}',
    mergeVoteTitle: '{{title}}: {{branches}}',
    mergeVoteSeparator: ' vs ',
    step: 'Step {{number}}',
    originalDocument: 'Original document',
  },
  implementationEvaluation: {
    noDate: 'No date',
    noEvaluationPlanned: 'No evaluation scheduled',
    fixedDate: 'Fixed date',
    relativeToFinalVote: 'Relative to the final vote',
    ...
    afterAdoption: '{{offset}} after adoption',
    statuses: {
      inProgress: 'In progress',
      inVote: 'In voting',
      rejected: 'Rejected',
      implemented: 'Implemented',
      implementationFailed: 'Implementation target missed',
      adoptedAndImplementing: 'Adopted and being implemented',
      adopted: 'Adopted',
    },
    outcomes: {
      yes: 'Yes',
  ...
  processTasks: {
    implementationEvaluation: 'Review implementation',
    supportConfirmation: 'Confirm support',
    scheduleEvent: 'Schedule event',
  },
  processTaskScheduling: {
    range: 'Allowed time for this task: {{min}} to {{max}}.',
    earliest: 'This event can start no earlier than {{min}}.',
    latest: 'This event must start no later than {{max}}.',
  },
  versionControl: {
  ...
  toasts: {
    ...
    invalidWorkflowTransition: 'Cannot change the workflow from {{from}} to {{to}}.',
    invalidWorkflowTransitionTo: 'Cannot change the workflow to {{to}}.',
    internalVoteStarted: 'Internal vote started for {{minutes}} minutes.',
