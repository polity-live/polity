export const groupsTranslations = {
  ...
  toasts: {
    ...
    positionCreateFailed: 'Failed to create position',
    ...
    positionHolderHistoryCreated: 'Position holder history created',
    positionHolderHistoryCreateFailed: 'Failed to create position holder history',
    positionHolderHistoryUpdated: 'Position holder history updated',
    positionHolderHistoryUpdateFailed: 'Failed to update position holder history',
  },
  list: {
