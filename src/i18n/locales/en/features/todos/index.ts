export const todosTranslations = {
  ...
  activity: {
    ...
    filter: {
      label: 'Filter activities by severity',
      all: 'All',
      normal: 'Normal',
      high: 'High',
    },
    ...
    actions: {
      created: 'created the todo',
      updated: 'updated the todo',
      statusChanged: 'changed the status',
      assigned: 'assigned the todo to',
      unassigned: 'removed the assignment from',
    ...
    assigneeCount_other: '{{count}} people',
    deletedUser: 'Deleted user',
    emptyValue: 'Empty',
    loading: 'Loading activities…',
    empty: 'No activities found for this filter.',
  },
} as const;
