...
import { getCityDesignAccess } from '../cityDesignPermissions';
...
describe('getCityDesignAccess', () => {
  it('uses amendment update rights for cityDesign mode changes', () => {
    const access = getCityDesignAccess({
  ...
  it('keeps users without update rights in read-only cityDesign mode', () => {
    const access = getCityDesignAccess({
