...
import type { CityDesignGeoPoint, CityDesignOrigin } from '../../types';
import { projectGeoPointToLocal, unprojectLocalPointToGeo } from '../cityDesignProjection';

const origin: CityDesignOrigin = {
  lat: 48.1397,
  lon: 11.5197,
  label: 'Euckenstrasse',
};

describe('cityDesignProjection', () => {
  ...
  it('round-trips projected points back to geographic coordinates', () => {
    const point: CityDesignGeoPoint = {
      lat: 48.140142,
      lon: 11.521039,
    };
