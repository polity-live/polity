...
const categoryIcons = {
  ...
  building: Building2,
  water: Waves,
} satisfies Record<CityDesignObjectCategory, LucideIcon>;
...
export function StreetCostSummaryView({
  ...
  const [openCategories, setOpenCategories] = useState<CityDesignObjectCategory[]>([]);
  ...
  const setCategoryOpen = (category: CityDesignObjectCategory, open: boolean) => {
