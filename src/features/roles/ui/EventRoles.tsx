...
export function EventRoles({ eventId }: { eventId: string }) {
  const { event, roles, accessRoles, dialogs, form, actions } = useEventRoles(eventId);
            ...
            <div className="space-y-4 py-4">
              ...
              <div className="space-y-2">
                ...
                <p className="text-muted-foreground text-xs">
                  How many participants can hold this role
                </p>
              </div>
                            ...
                            <AlertDialog>
                              ...
                              <AlertDialogContent>
                                <AlertDialogHeader>
                                  ...
                                  <AlertDialogDescription>
                                    Are you sure you want to delete '{role.title}'? This action
                                    cannot be undone.
                                  </AlertDialogDescription>
                                </AlertDialogHeader>
                                <AlertDialogFooter>
