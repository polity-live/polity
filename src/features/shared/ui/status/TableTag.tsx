...
const tableTagToneClassNames: Record<SearchCardGradientEntity, string> = {
  ...
  blog: 'border-blue-200/80 text-indigo-950 shadow-sm shadow-blue-200/40 dark:border-blue-900/70 dark:text-indigo-50',
  user: 'border-blue-200/80 text-blue-950 shadow-sm shadow-blue-200/40 dark:border-blue-800/70 dark:text-blue-50',
};
