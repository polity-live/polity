...
| Composition compatibility shims          | `ActionBar`, `StatsBar`, `SubscriberStatsBar`, `contact-dialog`, `create-review-card`, `editing-mode`, `entity-search-bar`, `entity-select-cards`, `global-loading-animation`, `hashtag-display`, `hashtag-editor`, `hashtag-input`, `inline-combobox`, `loading-spinner`, `not-found`, `resize-handle`, `scrollable-tabs`, `table-tag`, `toolbar`, `type-selector`, `user-select-card`, `user-table-cell`, `visibility-selector`                                                                                                                                                                                                        |
