...
import { AILoadingBar, AIMenu } from '@/features/shared/ui/ui-platejs/ai-menu.tsx';
import { AIAnchorElement, AILeaf } from '@/features/shared/ui/ui-platejs/ai-node.tsx';
  ...
  useHooks: ({ editor, getOption }) => {
    ...
    useChatChunk({
      onChunk: ({ chunk, isFirst, nodes }) => {
        const firstChunkDone = isFirst;
        const hasAiChat = !!getOption('streaming');

        if (mode === 'chat' && firstChunkDone && !hasAiChat && editor.selection) {
