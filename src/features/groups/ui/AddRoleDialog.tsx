      ...
      <ScrollableDialogContent className="!flex !max-h-[calc(100vh-2rem)] !max-w-3xl !flex-col !overflow-hidden sm:!max-w-3xl">
        ...
        <div className="min-h-0 flex-1 overflow-y-auto px-1 py-2">
          <div className="space-y-4 px-5 pb-2">
            <div className={featureThemeClassName('groupAddRoleDialogSuccessSurface')}>
              ...
              <div className="grid gap-4 md:grid-cols-2">
                ...
                <div className="space-y-2 md:col-span-2">
                  <FormControlLabel htmlFor="role-description">
                  ...
                  <p
                    className={cn(
                      ...
                      form.description.trim().length > 0
                        ? featureThemeClassName('authNameStepSuccessText')
            ...
            <div className={featureThemeClassName('groupAddRoleDialogSuccessSurfaceAlpha')}>
              <div className="mb-4 space-y-1">
                <h3 className="text-sm font-semibold">
              ...
              <div className="space-y-4">
                <div className="space-y-3">
                  <ChoiceCardField
                    id="role-assignee-kind"
                    label={translateText('generated.inline.0620_access_type_6f01b1a4')}
                ...
                <div className="space-y-3">
                  <ChoiceCardField
                    id="role-assignment"
                    label={translateText('generated.inline.0621_assignment_e55df441')}
            ...
            <div className={featureThemeClassName('groupAddRoleDialogSuccessSurfaceAlpha')}>
              ...
              <div className="grid gap-3 md:grid-cols-2">
                <SwitchField
                  label={translateText('generated.inline.0628_default_request_role_2ffe5004')}
                  description={translateText(
                ...
                />
                <SwitchField
                  label={translateText('generated.inline.0630_default_invite_role_641e8d6f')}
                  description={translateText(
...
function getValidatedSurfaceClassName(isValid: boolean) {
  return cn(isValid && featureThemeClassName('groupAddRoleDialogSuccessBorder'));
}
