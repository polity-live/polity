...
export function GroupSearchStepView({
  ...
  return (
    ...
    >
      <div className="flex min-h-full flex-col gap-5 lg:gap-6">
        <div>
        ...
        <div className="grid gap-5 lg:min-h-[18rem] lg:flex-1 lg:grid-cols-[minmax(0,1fr)_minmax(20rem,0.9fr)]">
          <div className="bg-card flex min-h-0 flex-col overflow-hidden rounded-lg border shadow-sm">
            ...
            <div className="min-h-[12rem] flex-1 space-y-2 overflow-y-auto p-2 lg:max-h-[clamp(18rem,42dvh,31rem)]">
              {groupsLoading ? (
