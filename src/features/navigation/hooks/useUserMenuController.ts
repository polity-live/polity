...
export function useUserMenuController({
  ...
  return {
    ...
    labels: {
      ...
      docsDialogDescription: t('navigation.userMenu.docsDialogDescription'),
      tutorial: t('navigation.userMenu.tutorial'),
      aiAssistant: t('navigation.userMenu.aiAssistant'),
      documentation: t('navigation.userMenu.documentation'),
      feedback: t('navigation.userMenu.feedback'),
