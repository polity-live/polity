...
interface UsePqlFilterBuilderDialogControllerOptions<TItem, TFieldKey extends string> {
  open: boolean;
...
export function usePqlFilterBuilderDialogController<TItem, TFieldKey extends string>({
  open,
  onOpenChange,
  fields,
  filter,
  onSave,
}: UsePqlFilterBuilderDialogControllerOptions<TItem, TFieldKey>) {
