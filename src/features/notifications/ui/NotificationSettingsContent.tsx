    ...
    <div className="space-y-6">
      ...
      <Card>
        ...
        <CardContent className="divide-y">
          ...
          />
          <SettingItem
            label={t('pages.notifications.settingsPage.groups.newPositions')}
            description={t('pages.notifications.settingsPage.groups.newPositionsDesc')}
            checked={settings.groupNotifications.newPositions}
            onCheckedChange={(checked) => updateGroupNotifications({ newPositions: checked })}
            disabled={isUpdating}
          />
          <SettingItem
          ...
          <SettingItem
            ...
            onCheckedChange={(checked) => updateGroupNotifications({ membershipInvitations: checked })}
            disabled={isUpdating}
          />
        </CardContent>
      </Card>
      ...
      <Card>
        ...
        <CardContent className="divide-y">
          ...
          />
          <SettingItem
            label={t('pages.notifications.settingsPage.events.positionChanges')}
            description={t('pages.notifications.settingsPage.events.positionChangesDesc')}
            checked={settings.eventNotifications.positionChanges}
            onCheckedChange={(checked) => updateEventNotifications({ positionChanges: checked })}
            disabled={isUpdating}
          />
          <SettingItem
          ...
          <SettingItem
            ...
            onCheckedChange={(checked) => updateEventNotifications({ participationRequests: checked })}
            disabled={isUpdating}
            adminOnly
          />
          <SettingItem
            ...
            onCheckedChange={(checked) => updateEventNotifications({ participationInvitations: checked })}
            disabled={isUpdating}
          />
          <SettingItem
      ...
      <Card>
        ...
        <CardContent className="divide-y">
          ...
          <SettingItem
            ...
            description={t('pages.notifications.settingsPage.amendments.changeRequestDecisionsDesc')}
            checked={settings.amendmentNotifications.changeRequestDecisions}
            onCheckedChange={(checked) => updateAmendmentNotifications({ changeRequestDecisions: checked })}
            disabled={isUpdating}
          />
          <SettingItem
          ...
          <SettingItem
            ...
            onCheckedChange={(checked) => updateAmendmentNotifications({ collaborationRequests: checked })}
            disabled={isUpdating}
            adminOnly
          />
          <SettingItem
            label={t('pages.notifications.settingsPage.amendments.collaborationInvitations')}
            description={t('pages.notifications.settingsPage.amendments.collaborationInvitationsDesc')}
            checked={settings.amendmentNotifications.collaborationInvitations}
            onCheckedChange={(checked) => updateAmendmentNotifications({ collaborationInvitations: checked })}
            disabled={isUpdating}
          />
          <SettingItem
      ...
      <Card>
        ...
        <CardContent className="divide-y">
          ...
          <SettingItem
            ...
            onCheckedChange={(checked) => updateSocialNotifications({ conversationRequests: checked })}
            disabled={isUpdating}
          />
        </CardContent>
      </Card>
        ...
        <CardContent className="space-y-6">
          ...
          <div className="flex items-center justify-between space-x-4 py-3">
            ...
            >
              ...
              <SelectContent>
                <SelectItem value="realtime">{t('pages.notifications.settingsPage.timeline.realtime')}</SelectItem>
                <SelectItem value="every5min">{t('pages.notifications.settingsPage.timeline.every5min')}</SelectItem>
                <SelectItem value="every15min">{t('pages.notifications.settingsPage.timeline.every15min')}</SelectItem>
                <SelectItem value="manual">{t('pages.notifications.settingsPage.timeline.manualOnly')}</SelectItem>
              </SelectContent>
            </Select>
          </div>
        </CardContent>
