...
vi.mock('@/features/notifications/utils/gated-toast', () => ({ gatedToast: { success: mocks.success } }));
...
beforeEach(() => { vi.clearAllMocks(); vi.spyOn(globalThis.crypto, 'randomUUID').mockReturnValue('uuid' as any); vi.spyOn(console, 'error').mockImplementation(() => undefined); });
