...
CREATE UNIQUE INDEX newsletter_subscription_email_key
...
CREATE INDEX newsletter_sync_outbox_pending_idx
...
GRANT ALL PRIVILEGES ON TABLE public.newsletter_subscription TO service_role;
GRANT ALL PRIVILEGES ON TABLE public.newsletter_sync_outbox TO service_role;
GRANT ALL PRIVILEGES ON TABLE public.resend_webhook_event TO service_role;
...
CREATE TRIGGER on_auth_user_newsletter_changed
  AFTER INSERT OR UPDATE OF email, email_confirmed_at ON auth.users
  FOR EACH ROW
  EXECUTE FUNCTION public.handle_auth_user_newsletter_change();

CREATE TRIGGER on_auth_user_newsletter_deleted
...
CREATE TRIGGER on_user_preference_newsletter_language_changed
